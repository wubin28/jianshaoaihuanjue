...
- [项目概述](#项目概述)
  ...
  - [项目结构概览](#项目结构概览)
  - [核心特性](#核心特性)
- [App Router架构](#app-router架构)
  - [核心概念](#核心概念)
  - [文件系统路由机制](#文件系统路由机制)
  - [与Pages Router的主要区别](#与pages-router的主要区别)
  - [核心优势](#核心优势)
  - [适用场景](#适用场景)
- [布局系统](#布局系统)
  - [RootLayout组件](#rootlayout组件)
  - [核心代码分析](#核心代码分析)
  - [布局系统优势](#布局系统优势)
  - [文件路径映射](#文件路径映射)
  - [适用场景](#适用场景-1)
- [页面组件](#页面组件)
  ...
  - [适用场景](#适用场景-2)
- [样式系统](#样式系统)
  - [Tailwind CSS集成](#tailwind-css集成)
  - [全局样式配置](#全局样式配置)
  - [核心配置分析](#核心配置分析-1)
  - [样式系统优势](#样式系统优势)
  - [Tailwind CSS 4.0新特性](#tailwind-css-40新特性)
  - [文件路径映射](#文件路径映射-2)
  - [适用场景](#适用场景-3)
- [开发工具链](#开发工具链)
  - [TypeScript配置](#typescript配置)
  - [ESLint代码检查](#eslint代码检查)
  - [Next.js构建配置](#nextjs构建配置)
  - [核心配置分析](#核心配置分析-2)
  - [开发工具链优势](#开发工具链优势)
  - [路径别名配置](#路径别名配置)
  - [文件路径映射](#文件路径映射-3)
...
- [服务端组件 vs 客户端组件](#服务端组件-vs-客户端组件)
  ...
  - [调试技巧](#调试技巧)
- [数据获取方式](#数据获取方式)
  - [App Router数据获取模式](#app-router数据获取模式)
  - [服务端组件中的数据获取](#服务端组件中的数据获取)
  - [缓存控制策略](#缓存控制策略)
  - [并行数据获取](#并行数据获取)
  - [客户端组件中的数据获取](#客户端组件中的数据获取)
  - [数据获取最佳实践](#数据获取最佳实践)
- [开发工作流实践](#开发工作流实践)
  - [日常开发命令](#日常开发命令)
  - [开发工作流程](#开发工作流程)
